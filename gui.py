"""GUI components with horizontal layout design."""
...
class HorizontalTranscriberWidget(QWidget):
    ...
    def create_top_section(self):
        ...
        lang_group.addWidget(QLabel("Язык:"))
        ...
        self.lang_combo.setCurrentIndex(0)  # Auto by default
        self.lang_combo.setToolTip("Язык аудио для распознавания")
        self.lang_combo.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Fixed)
        lang_group.addWidget(self.lang_combo)
        options_layout.addLayout(lang_group)
        ...
        self.benchmark_button.setToolTip("Бенчмарк производительности")
        self.benchmark_button.setFixedWidth(40)
        ...
        self.start_button.setToolTip("Начать обработку")
        ...
        self.stop_button.setToolTip("Остановить обработку")
        ...
        self.clear_button.setToolTip("Очистить очередь")
    ...
    def create_bottom_section(self):
        ...
        self.overall_progress_label.setFixedWidth(100)
    ...
    def start_processing(self):
        ...
        self.transcription_thread = TranscriptionThread(
            ...
            language=self.lang_combo.currentData()  # Get language code
        )
...
def main():
    ...
    dark_palette.setColor(QPalette.Window, QColor(Theme.BACKGROUND))
    dark_palette.setColor(QPalette.WindowText, QColor(Theme.TEXT_PRIMARY))
    dark_palette.setColor(QPalette.Base, QColor(Theme.SURFACE))
    dark_palette.setColor(QPalette.AlternateBase, QColor(Theme.SURFACE_HOVER))
    dark_palette.setColor(QPalette.Text, QColor(Theme.TEXT_PRIMARY))
    dark_palette.setColor(QPalette.Button, QColor(Theme.SURFACE))
    dark_palette.setColor(QPalette.ButtonText, QColor(Theme.TEXT_PRIMARY))
